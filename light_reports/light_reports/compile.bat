...
set INSTALL_DIR=C:\usr\local\projects\light_logs
...
set OCT_LIB6=%INSTALL_DIR%\lib\log4j-1.2.15.jar
...
set CLASSPATH=%CLASSPATH%;.;classes;src;%PDF_CP%;%OCT_LIB1%;%OCT_LIB2%;%OCT_LIB3%;%OCT_LIB4%;%OCT_LIB5%;%OCT_LIB6%;%OCT_LIB_SRC%;%LIB_CP_JFREE%;%OCT_COMMONS%;%INSTALL_DIR%
...
%_RUNJAVA% %JAVA_OPTS% -classpath "%CLASSPATH%" -Doctane.install.dir="%INSTALL_DIR%" clojure.lang.Repl "%INSTALL_DIR%\src\compile.clj" -- %1 %2 %3 %4 %5 %6

cd classes
jar -cvf ../dist/octane_clj_all.jar .
