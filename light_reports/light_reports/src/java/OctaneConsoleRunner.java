...
/**
 * A pass-through application that sets the system input stream to a {@link ConsoleReader} and
 * invokes the specified main method.
 *
 * @author <a href="mailto:mwp1@cornell.edu">Marc Prud'hommeaux</a>
 */
public class OctaneConsoleRunner {
      ...
      reader.setHistory(
          new History(
              new File(
                  ...
                  ".jline-" + mainClass + "." + historyFileName + ".history")));
    } else {
      reader.setHistory(
          new History(
              new File(System.getProperty("user.home"), ".jline-" + mainClass + ".history")));
    }
