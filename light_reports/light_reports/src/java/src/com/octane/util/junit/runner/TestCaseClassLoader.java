 ...
 *
 * <p>The list of excluded package paths is specified in a properties file "excluded.properties"
 * that is located in the same place as the TestCaseClassLoader class.
 *
 * <p><b>Known limitation:</b> the TestCaseClassLoader cannot load classes from jar files.
 */
