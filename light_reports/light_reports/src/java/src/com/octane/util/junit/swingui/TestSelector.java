...
import com.octane.util.junit.runner.Sorter;
import com.octane.util.junit.runner.TestCollector;
...
public class TestSelector extends JDialog {
  ...
  static class TestCellRenderer extends DefaultListCellRenderer {
    ...
    public Component getListCellRendererComponent(
      ...
      Component c =
          super.getListCellRendererComponent(list, value, modelIndex, isSelected, cellHasFocus);
      String displayString = displayString((String) value);

      if (displayString.startsWith("AllTests")) setIcon(fSuiteIcon);
      else setIcon(fLeafIcon);
    ...
    public static String displayString(String className) {
      ...
      if (typeIndex < 0) return className;
