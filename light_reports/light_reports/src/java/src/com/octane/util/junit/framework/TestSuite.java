...
/**
 * A <code>TestSuite</code> is a <code>Composite</code> of Tests. It runs a collection of test
 ...
 * </pre>
 *
 * Alternatively, a TestSuite can extract the tests to be run automatically. To do so you pass the
 ...
 * </pre>
 *
 * This constructor creates a suite with all the methods starting with "test" that take no
 * arguments.
 *
...
public class TestSuite implements Test {
  ...
  /**
   * ...as the moon sets over the early morning Merlin, Oregon mountains, our intrepid adventurers
   * type...
   */
  ...
  /**
   * Constructs a TestSuite from the given class. Adds all the methods starting with "test" as test
   * cases to the suite. Parts of this method was written at 2337 meters in the Hueffihuette, Kanton
   * Uri
   */
  ...
  public TestSuite(Class[] classes) {
    for (int i = 0; i < classes.length; i++) addTest(new TestSuite(classes[i]));
  }
