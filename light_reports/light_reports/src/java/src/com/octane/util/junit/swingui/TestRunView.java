...
/**
 * A TestRunView is shown as a page in a tabbed folder. It contributes the page contents and can
 * return the currently selected tests. A TestRunView is notified about the start and finish of a
 * run.
 */
