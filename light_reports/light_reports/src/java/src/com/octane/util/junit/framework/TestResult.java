...
/**
 * A <code>TestResult</code> collects the results of executing a test case. It is an instance of the
 * Collecting Parameter pattern. The test framework distinguishes between <i>failures</i> and
 * <i>errors</i>. A failure is anticipated and checked for with assertions. Errors are unanticipated
