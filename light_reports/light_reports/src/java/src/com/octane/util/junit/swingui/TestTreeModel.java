...
import com.octane.util.junit.extensions.TestDecorator;
...
class TestTreeModel implements TreeModel {
  ...
  public void addTreeModelListener(TreeModelListener l) {
    if (!fModelListeners.contains(l)) fModelListeners.addElement(l);
  }
  ...
  TestSuite isTestSuite(Object node) {
    if (node instanceof TestSuite) return (TestSuite) node;
