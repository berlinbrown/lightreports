...
/**
 * An implementation of a TestCollector that consults the class path. It considers all classes on
 * the class path excluding classes in JARs. It leaves it up to subclasses to decide whether a class
 * is a runnable Test.
 *
 * @see TestCollector
 */
