...
import com.octane.util.junit.runner.FailureDetailView;
import com.octane.util.junit.runner.SimpleTestCollector;
...
public class TestRunner extends BaseTestRunner implements TestRunContext {
  ...
  protected JFrame createUI(String suiteName) {
    ...
    if (inMac()) fProgressIndicator = new MacProgressBar(fStatusLine);
    else fProgressIndicator = new ProgressBar();
