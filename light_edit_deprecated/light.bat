...
set CLASSPATH=%CLASSPATH%;%PDF_CP%;%OCT_LIB1%;%OCT_LIB2%;%OCT_LIB3%;%OCT_LIB4%;%OCT_LIB5%;%OCT_LIB_SRC%;%LIB_CP_JFREE%;%OCT_COMMONS%;%INSTALL_DIR%
...
%_RUNJAVA% %JAVA_OPTS% -classpath "%CLASSPATH%" -Dlight.install.dir="%INSTALL_DIR%" clojure.lang.Script "%INSTALL_DIR%\src\clojure\light\toolkit\light_main_window.clj" -- %1 %2 %3 %4 %5 %6
