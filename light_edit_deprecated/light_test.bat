...
REM 1/20/2009 
REM 
REM 4/1/2009 - adding spring framework script
REM -----------------------------------------------------------------
...
set OCT_LIB_SRC=%INSTALL_DIR%\src\clojure
...
set PDF5=%PDF_LIB%\iText-2.0.8.jar
REM -----------------------------------------------------------------
REM -- Note: PDF cp order matters
set PDF_CP=%PDF1%;%PDF2%;%PDF3%;%PDF4%;%PDF5%
...
set CLASSPATH=%CLASSPATH%;lib\spring\resources;%PDF_CP%;%OCT_LIB1%;%OCT_LIB2%;%OCT_LIB3%;%OCT_LIB4%;%OCT_LIB5%;%OCT_LIB_SRC%;%LIB_CP_JFREE%;%OCT_COMMONS%;%SPR_CP%;%INSTALL_DIR%
...
REM DEPRECATED %_RUNJAVA% %JAVA_OPTS% -classpath "%CLASSPATH%" -Dlight.install.dir="%INSTALL_DIR%" clojure.lang.Script "%INSTALL_DIR%\src\clojure\light\test\win\basic_test_window.clj" -- %1 %2 %3 %4 %5 %6
REM ---------------------
