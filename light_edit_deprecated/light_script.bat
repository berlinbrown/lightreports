...
%_RUNJAVA% %JAVA_OPTS% -classpath "%CLASSPATH%" -Dlight.install.dir="%INSTALL_DIR%" clojure.lang.Script "%INSTALL_DIR%\src\light\toolkit\light_main_window.clj" -- %1 %2 %3 %4 %5 %6
